...
declare const imagen2: ModelReference<z$1.ZodObject<{
    ...
    aspectRatio: z$1.ZodOptional<z$1.ZodEnum<["1:1", "9:16", "16:9", "3:4", "4:3"]>>;
    negativePrompt: z$1.ZodOptional<z$1.ZodString>;
    seed: z$1.ZodOptional<z$1.ZodNumber>;
    location: z$1.ZodOptional<z$1.ZodString>;
    personGeneration: z$1.ZodOptional<z$1.ZodEnum<["dont_allow", "allow_adult", "allow_all"]>>;
    safetySetting: z$1.ZodOptional<z$1.ZodEnum<["block_most", "block_some", "block_few", "block_fewest"]>>;
    addWatermark: z$1.ZodOptional<z$1.ZodBoolean>;
    storageUri: z$1.ZodOptional<z$1.ZodString>;
    mode: z$1.ZodOptional<z$1.ZodEnum<["upscale"]>>;
    editConfig: z$1.ZodOptional<z$1.ZodObject<{
        /** Describes the editing intention for the request. */
        editMode: z$1.ZodOptional<z$1.ZodEnum<["inpainting-insert", "inpainting-remove", "outpainting", "product-image"]>>;
        ...
        maskMode: z$1.ZodOptional<z$1.ZodObject<{
            maskType: z$1.ZodEnum<["background", "foreground", "semantic"]>;
            classes: z$1.ZodOptional<z$1.ZodArray<z$1.ZodNumber, "many">>;
        ...
        maskDilation: z$1.ZodOptional<z$1.ZodNumber>;
        guidanceScale: z$1.ZodOptional<z$1.ZodNumber>;
        productPosition: z$1.ZodOptional<z$1.ZodEnum<["reposition", "fixed"]>>;
    ...
    upscaleConfig: z$1.ZodOptional<z$1.ZodObject<{
        upscaleFactor: z$1.ZodEnum<["x2", "x4"]>;
    }, "strip", z$1.ZodTypeAny, {
        upscaleFactor: "x2" | "x4";
    }, {
        upscaleFactor: "x2" | "x4";
...
declare const imagen3: ModelReference<z$1.ZodObject<{
    version: z$1.ZodOptional<z$1.ZodString>;
    temperature: z$1.ZodOptional<z$1.ZodNumber>;
    maxOutputTokens: z$1.ZodOptional<z$1.ZodNumber>;
    topK: z$1.ZodOptional<z$1.ZodNumber>;
...
declare const imagen3Fast: ModelReference<z$1.ZodObject<{
    version: z$1.ZodOptional<z$1.ZodString>;
    temperature: z$1.ZodOptional<z$1.ZodNumber>;
    maxOutputTokens: z$1.ZodOptional<z$1.ZodNumber>;
    topK: z$1.ZodOptional<z$1.ZodNumber>;
...
declare const SUPPORTED_IMAGEN_MODELS: {
    imagen2: ModelReference<z$1.ZodObject<{
        version: z$1.ZodOptional<z$1.ZodString>;
        temperature: z$1.ZodOptional<z$1.ZodNumber>;
        maxOutputTokens: z$1.ZodOptional<z$1.ZodNumber>;
        topK: z$1.ZodOptional<z$1.ZodNumber>;
    ...
    imagen3: ModelReference<z$1.ZodObject<{
        version: z$1.ZodOptional<z$1.ZodString>;
        temperature: z$1.ZodOptional<z$1.ZodNumber>;
        maxOutputTokens: z$1.ZodOptional<z$1.ZodNumber>;
        topK: z$1.ZodOptional<z$1.ZodNumber>;
    ...
    'imagen3-fast': ModelReference<z$1.ZodObject<{
        version: z$1.ZodOptional<z$1.ZodString>;
        temperature: z$1.ZodOptional<z$1.ZodNumber>;
        maxOutputTokens: z$1.ZodOptional<z$1.ZodNumber>;
        topK: z$1.ZodOptional<z$1.ZodNumber>;
...
declare function imagenModel(name: string, client: GoogleAuth, options: PluginOptions): _genkit_ai_ai_model.ModelAction<z$1.ZodObject<{
    version: z$1.ZodOptional<z$1.ZodString>;
    temperature: z$1.ZodOptional<z$1.ZodNumber>;
    maxOutputTokens: z$1.ZodOptional<z$1.ZodNumber>;
    topK: z$1.ZodOptional<z$1.ZodNumber>;
...
export { vertexAiRetrievers as $, type CrowdingTag as A, NeighborSchema as B, CrowdingTagSchema as C, Datapoint as D, type Neighbor as E, type FindNeighborsResponse as F, GeminiConfigSchema as G, FindNeighborsResponseSchema as H, type IIndexDatapoint as I, VertexAIVectorRetrieverOptionsSchema as J, type VertexAIVectorRetrieverOptions as K, VertexAIVectorIndexerOptionsSchema as L, type VertexAIVectorIndexerOptions as M, NumericRestrictionSchema as N, type DocumentRetriever as O, type PluginOptions as P, type DocumentIndexer as Q, RestrictionSchema as R, SUPPORTED_V1_MODELS as S, type VectorSearchOptions as T, getBigQueryDocumentRetriever as U, type VertexVectorSearchOptions as V, getBigQueryDocumentIndexer as W, getFirestoreDocumentRetriever as X, getFirestoreDocumentIndexer as Y, vertexAiIndexerRef as Z, vertexAiIndexers as _, geminiProVision as a, vertexAiRetrieverRef as a0, textEmbedding004 as a1, textEmbeddingGecko as a2, textEmbeddingGecko001 as a3, textEmbeddingGecko002 as a4, textEmbeddingGecko003 as a5, textEmbeddingGeckoMultilingual001 as a6, textMultilingualEmbedding002 as a7, vertexAI as a8, TaskTypeSchema as a9, type TaskType as aa, TextEmbeddingGeckoConfigSchema as ab, type TextEmbeddingGeckoConfig as ac, SUPPORTED_EMBEDDER_MODELS as ad, textEmbeddingGeckoEmbedder as ae, gemini15Pro as b, gemini15ProPreview as c, gemini15FlashPreview as d, gemini15Flash as e, SUPPORTED_V15_MODELS as f, geminiPro as g, SUPPORTED_GEMINI_MODELS as h, toGeminiMessage as i, fromGeminiCandidate as j, geminiModel as k, imagen2 as l, imagen3 as m, imagen3Fast as n, SUPPORTED_IMAGEN_MODELS as o, imagenModel as p, type IFindNeighborsRequest as q, type IFindNeighborsResponse as r, type ISparseEmbedding as s, toGeminiSystemInstruction as t, type IRestriction as u, type INumericRestriction as v, SparseEmbeddingSchema as w, type SparseEmbedding as x, type Restriction as y, type NumericRestriction as z };
