...
function geminiModel(name, vertexClientFactory, options) {
  ...
  return (0, import_model.defineModel)(
    ...
    (request, streamingCallback) => __async(this, null, function* () {
      ...
      if ((_l = request.config) == null ? void 0 : _l.googleSearchRetrieval) {
        (_m = chatRequest.tools) == null ? void 0 : _m.push({
          googleSearchRetrieval: request.config.googleSearchRetrieval
        });
      }
      if ((_n = request.config) == null ? void 0 : _n.vertexRetrieval) {
      ...
      if (streamingCallback) {
        ...
        try {
          for (var iter = __forAwait(result.stream), more, temp, error; more = !(temp = yield iter.next()).done; more = false) {
            ...
            (_p = item.candidates) == null ? void 0 : _p.forEach((candidate) => {
        ...
        if (!((_q = response.candidates) == null ? void 0 : _q.length)) {
          throw new Error("No valid candidates returned.");
        }
        return {
          candidates: ((_r = response.candidates) == null ? void 0 : _r.map((c) => fromGeminiCandidate(c, jsonMode))) || [],
          custom: response
        };
      } else {
        let result;
        ...
        if (!((_s = result == null ? void 0 : result.response.candidates) == null ? void 0 : _s.length)) {
          throw new Error("No valid candidates returned.");
        }
        const responseCandidates = ((_t = result.response.candidates) == null ? void 0 : _t.map(
        ...
        return {
          ...
          usage: __spreadProps(__spreadValues({}, (0, import_model.getBasicUsageStats)(request.messages, responseCandidates)), {
            inputTokens: (_u = result.response.usageMetadata) == null ? void 0 : _u.promptTokenCount,
            outputTokens: (_v = result.response.usageMetadata) == null ? void 0 : _v.candidatesTokenCount,
            totalTokens: (_w = result.response.usageMetadata) == null ? void 0 : _w.totalTokenCount
          })
        };
      }
    })
